...
(function ($) {
    ...
    $.fn.ivupdown = function (options) {
        ...
        this.addClass('ivupdowninput').wrap(function () {
            return "<div class='ivupdownwrap'></div>";
        }).after('<div class="shoping_cart_minus "><a href="#" class="ivminus"></a></div>')
        .before('<div class="shoping_cart_plus "><a href="#" class="ivplus"></a></div>')
        //.before('<span class="ivupdowndimprice">(' + settings.currency + settings.price.toFixed(2) + ')</span>')
        .before('<i class="ivupdowndim">' + settings.dimension + '</i>')
        ...
        this.parent('.ivupdownwrap').find('.ivplus').click(onPlus);
        this.parent('.ivupdownwrap').find('.ivminus').click(onMinus);
