...
var app = Sammy(function () {
    ...
    this.get("#!/firstCategoryProducts/:shopID", function (context) {
        ...
        var cacheInstance = getCache(), params = $.extend(context.params, cacheInstance), requestingCase = params.requestCase || "category", factory = FiltrationHandlersFactory, shopID = params.shopID;
